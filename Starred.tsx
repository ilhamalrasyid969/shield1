...
import { LayoutGrid, List, Search, X, Star } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-4">
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {filteredFiles.map((file) => (
              <FileCard
                ...
                onStar={() => starMutation.mutate({ id: file.id, starred: false })}
          ...
          <FileList
            ...
            onStar={(file) => starMutation.mutate({ id: file.id, starred: false })}
      ...
      <FilePreviewModal
        ...
        onStar={() => previewFile && starMutation.mutate({ id: previewFile.id, starred: false })}
